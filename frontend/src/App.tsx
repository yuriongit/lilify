...
export const App = () => {
    ...
    return (
        <main className="min-h-screen tracking-[-0.015em] bg-zinc-900 text-zinc-100 flex items-center justify-center p-4 sm:p-6 selection:bg-zinc-800 selection:text-zinc-100">
            <div className="w-full max-w-md">
                {invalidRedirectUrlMsg.length > 1 || fetchRedirectUrlError ? (
                    <div className="w-full flex flex-col justify-center items-center text-center gap-4">
                        <div className="w-fit flex items-center flex-col gap-2">
                            <h1 className="text-5xl w-fit font-medium flex items-center gap-2.5">
                                <span>{fetchRedirectUrlError ? 500 : 404}</span>
                        ...
                        <button
                            ...
                            className="hover: white/90 hover:cursor-pointer text-black bg-white rounded px-2.5 text-sm py-1 font-medium flex items-center gap-2"
                        >
